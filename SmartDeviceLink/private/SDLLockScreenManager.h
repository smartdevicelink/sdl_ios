 ...
 */
- (instancetype)initWithConfiguration:(SDLLockScreenConfiguration *)config notificationDispatcher:(
id)dispatcher presenter:(id<SDLViewControllerPresentable>)presenter;
