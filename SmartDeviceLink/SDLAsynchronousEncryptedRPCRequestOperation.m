//
//  SDLAsynchronousEncryptedRPCRequestOperation.m
//  SmartDeviceLink
//
...
@interface SDLAsynchronousEncryptedRPCRequestOperation ()
...
@implementation SDLAsynchronousEncryptedRPCRequestOperation {
    BOOL executing;
    BOOL finished;
}
...
- (void)sdl_sendRequest:(SDLRPCRequest *)request {
    ...
    [self.connectionManager sendEncryptedConnectionRequest:request withResponseHandler:^(__kindof SDLRPCRequest * _Nullable request, __kindof SDLRPCResponse * _Nullable response, NSError * _Nullable error) {
