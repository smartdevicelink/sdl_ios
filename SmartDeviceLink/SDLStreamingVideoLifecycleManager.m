...
- (void)sdl_videoCapabilityDidUpdateStarting:(nullable SDLVideoStreamingCapability *)videoCapabilityUpdated {
    ...
    if (1 < capabilityMatches.count) {
        ...
        appCapabilityMatch.additionalVideoStreamingCapabilities = @[];
    }
