...
- (instancetype)init {
    ...
    self.functionIds = @{
                         ...
                         @65: SDLRPCFunctionNameDefault,
                         @66: SDLRPCFunctionNamePerformChoiceSet,
                         @67: SDLRPCFunctionNameScreenUpdate,
                         @68: SDLRPCFunctionNameAccessMicrophone,
                         @69: SDLRPCFunctionNameOpenMenu,
