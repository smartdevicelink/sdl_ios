 ...
 *
  *  If connecting to SDL Core v.6.0+, the scrollable message can be cancelled programatically using the `cancelID`. On older versions of SDL Core, the scrollable message will persist until the user has interacted with the scrollable message or the specified timeout has elapsed.
 *
 *  @since SDL 2.0
 */
