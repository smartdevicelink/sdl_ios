 ...
 *
 *  If connecting to SDL Core v.6.0+, the slider can be cancelled programatically using the `cancelID`. On older versions of SDL Core, the slider will persist until the user has interacted with the slider or the specified timeout has elapsed.
 *
 * Since SDL 2.0
 */
 ...
 *  @return                 An SDLSlider object
 */
- (instancetype)initWithNumTicks:(UInt8)numTicks position:(UInt8)position __deprecated_msg("Use initWithNumTicks:position:sliderHeader:sliderFooters:timeout:cancelID: instead");
 ...
 *  @return                 An SDLSlider object
 */
- (instancetype)initWithNumTicks:(UInt8)numTicks position:(UInt8)position sliderHeader:(NSString *)sliderHeader sliderFooter:(nullable NSString *)sliderFooter timeout:(UInt16)timeout __deprecated_msg("Use initWithNumTicks:position:sliderHeader:sliderFooters:timeout:cancelID: instead");
 ...
 *  @return                 An SDLSlider object
 */
- (instancetype)initWithNumTicks:(UInt8)numTicks position:(UInt8)position sliderHeader:(NSString *)sliderHeader sliderFooters:(nullable NSArray<NSString *> *)sliderFooters timeout:(UInt16)timeout __deprecated_msg("Use initWithNumTicks:position:sliderHeader:sliderFooters:timeout:cancelID: instead");
