 ...
 *
 *  If connecting to SDL Core v.6.0+, the perform interaction can be canceled programatically using the `cancelID`. On older versions of SDL Core, the perform interaction will persist until the user has interacted with the perform interaction or the specified timeout has elapsed.
 *
