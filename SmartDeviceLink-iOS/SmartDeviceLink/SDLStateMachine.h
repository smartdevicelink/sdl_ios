 ...
 *
 *  Additionally, NSNotifications will be fired. The notifications will be of type "com.sdl.notification.statemachine.`TargetClass`.`NotificationType`". The target class is generated by calling `NSStringFromClass([target Class])`, and the notification type is the same as the selector generated during a transition. All transition types will be sent for each transition.
 *
