...
describe(@"SetMediaClocktimer Spec", ^ {
    ...
    describe(@"when initialized", ^{
        ...
        it(@"should properly initialize with countUpFromStartTimeInterval:endTimeInterval:playPauseIndicator:", ^{
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with countUpFromStartTimeInterval:endTimeInterval:playPauseIndicator:forwardSeekIndicator:backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [SDLSetMediaClockTimer countUpFromStartTimeInterval:testTime1Interval toEndTimeInterval:testTime2Interval playPauseIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
        ...
        it(@"should properly initialize with countUpFromStartTime:endTime:playPauseIndicator:", ^{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with countUpFromStartTime:endTime:playPauseIndicator:forwardSeekIndicator:backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [SDLSetMediaClockTimer countUpFromStartTime:time1 toEndTime:time2 playPauseIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
        ...
        it(@"should properly initialize with countDownFromStartTimeInterval:endTimeInterval:playPauseIndicator:", ^{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with countDownFromStartTimeInterval:endTimeInterval:playPauseIndicator:forwardSeekIndicator:backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [SDLSetMediaClockTimer countDownFromStartTimeInterval:testTime1Interval toEndTimeInterval:testTime2Interval playPauseIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
        ...
        it(@"should properly initialize with countDownFromStartTime:endTime:playPauseIndicator:", ^{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with countDownFromStartTime:endTime:playPauseIndicator:forwardSeekIndicator:backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [SDLSetMediaClockTimer countDownFromStartTime:time1 toEndTime:time2 playPauseIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with resumeWithPlayPauseIndicator:forwardSeekIndicator:backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [SDLSetMediaClockTimer resumeWithPlayPauseIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
...
#pragma clang diagnostic pop
        ...
        it(@"should properly initialize with initWithUpdateMode:startTime:endTime:playPauseIndicator:forwardSeekIndicator: backSeekIndicator:", ^{
            SDLSetMediaClockTimer *testRequest = [[SDLSetMediaClockTimer alloc] initWithUpdateMode:testUpdateMode startTime:time1 endTime:time2 audioStreamingIndicator:testIndicator forwardSeekIndicator:forwardSeekTest backSeekIndicator:backSeekTest];
