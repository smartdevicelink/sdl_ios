...
describe(@"GetFunctionName Tests", ^ {
    it(@"Should return the correct function name", ^ {
        ...
        expect([functionID functionNameForId:55]).to(equal(SDLNamePerformAppServiceInteraction));
        ...
        expect([functionID functionNameForId:32787]).to(equal(SDLNameOnSystemCapabilityUpdated));
