...
+ (void)testPutFiles:(NSArray<SDLPutFile *> *)putFiles file:(SDLFile *)testFile mtuSize:(NSUInteger)mtuSize;
    ...
    describe(@"When uploading data", ^{
        ...
        context(@"data should be split into smaller packets if too large to send all at once", ^{
            it(@"should split the data from a short chunk of text in memory correctly", ^{
                ...
                [UploadFileOperationSpecHelpers testPutFiles:testPutFiles file:testFile mtuSize:testMTUSize];
            ...
            it(@"should split the data from a large image in memory correctly", ^{
                ...
                [UploadFileOperationSpecHelpers testPutFiles:putFiles file:testFile mtuSize:testMTUSize];
