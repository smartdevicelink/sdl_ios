...
describe(@"a lifecycle manager", ^{
    ...
    beforeEach(^{
        ...
        testConfig.lifecycleConfig.hmiLanguage = SDLLanguageEnUs;
        ...
        describe(@"transitioning to the ready state", ^{
            ...
            context(@"when the register response returns different language than the one passed with the lifecycle configuration", ^{
                beforeEach(^{
                     ...
                     expect(testManager.configuration.lifecycleConfig.hmiLanguage).to(equal(testConfig.lifecycleConfig.hmiLanguage));
                ...
                it(@"should should update the configuration when the app supports the head unit language", ^{
                    ...
                    OCMStub([testManager sendConnectionManagerRequest:[OCMArg any] completionHandler:[OCMArg invokeBlock]]);
                ...
                it(@"should not update the configuration when the app does not support the head unit language", ^{
                    ...
                    expect(testManager.configuration.lifecycleConfig.hmiLanguage).toEventually(equal(SDLLanguageEnUs));
